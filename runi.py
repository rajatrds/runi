...
\033[1;36m
  ...
  ____  ____    ____      _     ___    __ ___________         ___    __ ______      ___   ____   
 6MMMMb\`MM'    `MM'     dM.    `MM    d'  `MM`MMMMMMMb.       `MM    d'  `MM`MM\     `M'  6MMMMb/ 
6M'    ` MM      MM     ,MMb     MM   d'   MM MM    `Mb        MM   d'   MM MMM\     M  8P    YM 
MM       MM      MM     d'YM.    MM  d'    MM MM     MM        MM  d'    MM M\MM\    M 6M      Y 
YM.      MM      MM    ,P `Mb    MM d'     MM MM    .M9        MM d'     MM M \MM\   M MM        
 YMMMMb  MMMMMMMMMM    d'  YM.   MMd'      MM MMMMMMM(         MMd'      MM M  \MM\  M MM        
     `Mb MM      MM   ,P   `Mb   MMYM.     MM MM    `Mb        MMYM.     MM M   \MM\ M MM     ___
      MM MM      MM   d'    YM.  MM YM.    MM MM     MM        MM YM.    MM M    \MM\M MM     `M'
      MM MM      MM  ,MMMMMMMMb  MM  YM.   MM MM     MM        MM  YM.   MM M     \MMM YM      M 
L    ,M9 MM      MM  d'      YM. MM   YM.  MM MM    .M9        MM   YM.  MM M      \MM  8b    d9 
MYMMMM9 _MM_    _MM_dM_     _dMM_MM_   YM._MM_MMMMMMM9'       _MM_   YM._MM_M_      \M   YMMMM9 

\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD MARUF
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD MARUF
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD MARUF
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://facebook.com/groups/686565042010020/')
